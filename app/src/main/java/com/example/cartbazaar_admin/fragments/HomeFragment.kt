...
import com.example.cartbazaar_admin.activity.AllOrderActivity
import com.example.cartbazaar_admin.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.allOrderDetailsBtn.setOnClickListener {
